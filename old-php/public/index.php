...
<body class="scroll-smooth lock-scroll" style="font-family: 'Josefin Sans', sans-serif;">
      ...
      <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4">
        <div class="col">
          <a href="https://www.youtube.com/@Langz7z" class="text-decoration-none" target="_blank">
            <div class="card card-hover card-cover h-100 overflow-hidden rounded-4 shadow" style="background-image: url('assets/img/gambar/thumbnail.png'); background-size: cover; background-repeat: no-repeat;">
        ...
        <div class="col">
          <a href="https://www.tiktok.com/@langz7z" class="text-decoration-none" target="_blank">
            <div class="card card-hover card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow" style="background-image: url('assets/img/gambar/gaming.jpg'); background-size: cover; background-repeat: no-repeat;">
              <div class="d-flex flex-column h-100 p-6 md:p-12 custom-card-p pb-3 text-white text-shadow-1">
        ...
        <div class="col">
          <a href="gallery.php" class="text-decoration-none">
            <div class="card card-hover card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow" style="background-image: url('assets/img/gambar/wmv\ \(20\).jpg'); background-size: cover; background-repeat: no-repeat;">
  ...
  <!-- Tambahkan div wrapper dengan margin-top dan margin-bottom yang jelas -->
  <div id="contact" class="container px-4" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="row justify-content-center">
      <div class="col-12 col-lg-8">
        <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5">
          <h1 class="text-center mb-5 fw-bold text-3xl md:text-4xl">Contact</h1>
          <form id="contactForm" class="row g-3">
            ...
            <div class="col-12 form-floating mb-4">
              <textarea name="pesan" class="form-control rounded-3" placeholder="Pesan" id="floatingTextarea2" style="height: 150px; resize: none;" required></textarea>
              <label for="floatingTextarea2" class="ms-2">Comments</label>
            </div>
            <div class="col-12 text-center">
              <button type="submit" class="btn btn-primary btn-lg px-5 rounded-pill shadow-sm w-100 md:w-auto">Send Message</button>
            </div>
          </form>
